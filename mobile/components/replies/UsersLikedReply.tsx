import { styles } from "../../styles/UsersLikedReply.styles";
...
interface UsersLikedReplyProps {
  replyId: number;
  visible: boolean;
  onClose: () => void;
  likes: UserLike[];
...
const UsersLikedReply: React.FC<UsersLikedReplyProps> = ({
  replyId,
  visible,
  onClose,
  likes,
...
export default UsersLikedReply;
